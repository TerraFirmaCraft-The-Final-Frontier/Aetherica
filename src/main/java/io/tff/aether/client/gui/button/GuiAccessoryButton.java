...
public class GuiAccessoryButton extends GuiButton
{
    ...
    protected static final ResourceLocation BUTTON_TEXTURE = new ResourceLocation("aether", "textures/gui/inventory/button/cloud.png");

    protected static final ResourceLocation BUTTON_HOVERED_TEXTURE = new ResourceLocation("aether", "textures/gui/inventory/button/cloud_hover.png");
