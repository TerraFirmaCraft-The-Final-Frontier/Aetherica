...
import io.tff.aether.client.audio.AetherMusicHandler;
import io.tff.aether.client.gui.GuiAetherInGame;
import io.tff.aether.client.gui.GuiSunAltar;
import io.tff.aether.client.gui.toast.GuiAetherToast;
import io.tff.aether.client.renders.AetherEntityRenderingRegistry;
import io.tff.aether.client.renders.blocks.BlockRendering;
import io.tff.aether.client.renders.items.ItemRendering;
...
public class ClientProxy extends CommonProxy
{
	...
	public void generateTexturePack()
	{
		try
		{
			...
			File buckets = new File(resourcePacks + "/Aether b1.7.3 Textures/assets/aether/textures/items/misc/buckets");
			File weapons = new File(resourcePacks + "/Aether b1.7.3 Textures/assets/aether/textures/items/weapons");
			File armor = new File(resourcePacks + "/Aether b1.7.3 Textures/assets/aether/textures/items/armor");
			File accessories = new File(resourcePacks + "/Aether b1.7.3 Textures/assets/aether/textures/items/accessories");
