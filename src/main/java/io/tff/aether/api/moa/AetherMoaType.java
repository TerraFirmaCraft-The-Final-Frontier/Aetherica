package io.tff.aether.api.moa;

import io.tff.aether.api.AetherRegistryEntry;
...
public class AetherMoaType extends AetherRegistryEntry<AetherMoaType>
{
	...
	public ResourceLocation getTexture(boolean saddled)
	{
		...
		return new ResourceLocation("aether", "textures/entities/moa/" + ("moa_") + this.getRegistryName().getPath().toLowerCase() + ".png");
	}
